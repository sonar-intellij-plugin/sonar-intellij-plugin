...
public class Settings {
  ...
  public Settings(String serverName, Collection<Resource> resources, String localAnalysisScripName, String workingDirSelection, String alternativeWorkingDirPath, Boolean useAlternativeWorkingDir) {
  ...
  public boolean equals(Object o) {
    ...
    if (alternativeWorkingDirPath != null ? !alternativeWorkingDirPath.equals(settings.alternativeWorkingDirPath) : settings.alternativeWorkingDirPath != null)
      return false;
    ...
    if (serverName != null ? !serverName.equals(settings.serverName) : settings.serverName != null)
      return false;
    if (useAlternativeWorkingDir != null ? !useAlternativeWorkingDir.equals(settings.useAlternativeWorkingDir) : settings.useAlternativeWorkingDir != null)
      return false;
    if (workingDirSelection != null ? !workingDirSelection.equals(settings.workingDirSelection) : settings.workingDirSelection != null)
      return false;
  ...
  public int hashCode() {
    ...
    result = 31 * result + (workingDirSelection != null ? workingDirSelection.hashCode() : 0);
    result = 31 * result + (alternativeWorkingDirPath != null ? alternativeWorkingDirPath.hashCode() : 0);
    result = 31 * result + (useAlternativeWorkingDir != null ? useAlternativeWorkingDir.hashCode() : 0);
    return result;
  }
